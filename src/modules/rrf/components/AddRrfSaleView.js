    ...
    return (
        <SafeAreaView>
                    ...
                    <>
                        <Content>
                            <View style={styles.content} >
                                <Card shadow style={styles.card}>
                                    <View style={{ justifyContent: 'space-between', marginTop: convertHeight(15) }}>
                                        <View style={{ marginTop: convertHeight(8) }}>
                                            <Input
                                                label={<Text category='h5' style={styles.label} >{I18n.t('rrf_name')}</Text>}
                                                size='large'
                                                value={name}
                                                disabled
                                            />
                                            ...
                                            return (
                                                <Card
                                                    ...
                                                    <View style={{ flexDirection: 'row', justifyContent: "flex-end" }}>
                                                        <TouchableOpacity onPress={() => props.navigateToAddItem({ vendorId: vendorName, item: item, title: 'rrf_sale' })} style={[styles.circle]}>
                                ...
                                <View style={{ bottom: convertWidth(55), marginTop: convertWidth(15), marginBottom: convertWidth(15), flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <Button
                                        appearance='outline'
                                        size='small'
            ...
            <TouchableOpacity
                onPress={() => {
                    if (vendorName) {
                        props.navigateToAddItem({ vendorId: vendorName, title: 'rrf_sale' });
                    } else {

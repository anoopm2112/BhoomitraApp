...
const PaymentHistorySubscriptionListView = (props) => {
    ...
    const renderItem = ({ item }) => {
        ...
        return (
            <AnimatedView
                ...
                duration={500}
            >
                {COLLECTION_TYPE.SUBSCRIPTION === item.collectionTypeId &&
                    <View style={[Platform.OS === 'android' ? styles.androidShadow : styles.iOSShadow, styles.viewStyle, styles.card]}>
                        <TouchableOpacity
                        // onPress={() => props.navigateToPaymentHistoryDetails(item)}
                        >
...
export default PaymentHistorySubscriptionListView;

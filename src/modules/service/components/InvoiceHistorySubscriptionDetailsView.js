...
const { SafeAreaView, Text, Content, Header, Icon, Button, Card } = components;
const { DATE_FORMAT } = constants;

const InvoiceHistorySubscriptionDetailsView = (props) => {
                        ...
                        <View style={styles.secondViewContainer}>
                            <View style={styles.rowView}>
                                ...
                                <Text category='h5' style={styles.textStyle}>
                                    {data.summary.subscribedFrom ? convertToLocalDate(data.summary.subscribedFrom) : ''}
                                </Text>
                            </View>
                            <View style={styles.rowView}>
                                <View style={styles.keyTextStyle}>
                                ...
                                <Text category='h5' style={styles.fullColonSpace}>:</Text>
                                <Text category='h5' style={styles.textStyle}>
                                    {data.summary.subscribedTo ? convertToLocalDate(data.summary.subscribedTo) : ''}
                                </Text>
                            </View>
                        </View>
                        <View style={styles.secondViewContainer}>
...
export default InvoiceHistorySubscriptionDetailsView;
